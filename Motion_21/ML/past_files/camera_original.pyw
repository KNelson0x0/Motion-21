    ...
    def run_cam(self):
        ...
        while (go):
            ...
            try:
                ...
                #For Z
                #roi_z = self.rgb_img_rect
                #roi_z = cv2.circle(roi_z, (350, 100), 8, (0, 0, 255), -1) #image, center, radius, color, fill
                #roi_z = cv2.circle(roi_z, (500, 100), 8, (0, 0, 255), -1)
                #roi_z = cv2.circle(roi_z, (350, 250), 8, (0, 0, 255), -1)
                #roi_z = cv2.circle(roi_z, (500, 250), 8, (0, 0, 255), -1)
                #roi_z = cv2.arrowedLine(roi_z, (370, 100), (480, 100), (0, 0, 255), 3) #image, start_point, end_point, color, thickness 
                #roi_z = cv2.arrowedLine(roi_z, (480, 120), (370, 230), (0, 0, 255), 3)
                #roi_z = cv2.arrowedLine(roi_z, (370, 250), (480, 250), (0, 0, 255), 3)

                #self.cropped_frame_z = roi_z
