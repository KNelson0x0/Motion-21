...
'''
    ...
    def home_window(self):
        ...
        self.motion21_title = customtkinter.CTkLabel(master=self.frame_right, text = "  MOTION 21", font = ("Segoe UI", 100, "bold"))
        self.motion21_title.grid(row=0, column=0, padx=0, pady=5)
        ...
        self.button1.grid(row=5, column=0, padx=0, pady=5)
