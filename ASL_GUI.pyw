...
class App(customtkinter.CTk):
    ...
    def user_train(self, id):
        ...
        self.label7 = customtkinter.CTkLabel(master=self.frame_right, text = "Please sign the letter \"A\" that you want \nmotion 21 to use as an example!", font=("Segoe UI", 20), width = 450, height = 100, fg_color=("gray38"), corner_radius = 8, compound = "bottom")
    ...
    def start_lesson(self):
        ...
        self.label12 = customtkinter.CTkLabel(master=self.frame_right, text = "Total Accuracy: 100%", font=("Segoe UI", 14))
