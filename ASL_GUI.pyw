...
class App(customtkinter.CTk):
    ...
    def user_train(self, id):
        ...
        self.home_example_image = self.load_image("/images/HomeExample.png", 400, 335)
    ...
    def load_image(self, path, image_size1, image_size2):
        return ImageTk.PhotoImage(Image.open(r"C:\Users\pccin\source\repos\Motion-21\Motion_21\GUI" + path).resize((image_size1, image_size2)))
    ...
    def home_window(self):
        ...
        #Images for left side of window
        self.home_image = self.load_image("/images/home.png", 25, 25)
        self.home_example_image = self.load_image("/images/HomeExample.png", 700, 600)
        self.settings_image = self.load_image("/images/settings.png", 25, 25)
        self.exit_image = self.load_image("/images/exit.png", 25, 25)
        ...
        self.label4 = customtkinter.CTkLabel(master=self.frame_right, image = self.home_example_image, width = 250, height = 200)
